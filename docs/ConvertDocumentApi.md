...
> string ConvertDocumentXlsxToPdf(ctx, inputFile)
...
> XlsxToPngResult ConvertDocumentXlsxToPng(ctx, inputFile)
...
> TextConversionResult ConvertDocumentXlsxToTxt(ctx, inputFile)
