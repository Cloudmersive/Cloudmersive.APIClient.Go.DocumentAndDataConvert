...
**StartDeleteSlideNumber** | **int32** | Slide number (1-based) to start deleting slides; inclusive | [optional] [default to null]
**EndDeleteSlideNumber** | **int32** | Slide number (1-based) to stop deleting slides; inclusive | [optional] [default to null]
