...
**StartDeletePageNumber** | **int32** | Page number (1-based) to start deleting pages; inclusive | [optional] [default to null]
**EndDeletePageNumber** | **int32** | Page number (1-based) to stop deleting pages; inclusive | [optional] [default to null]
