...
**RemoveHeaders** | **bool** | True if you would like to remove all headers from the input document, false otherwise | [optional] [default to null]
**RemoveFooters** | **bool** | True if you would like to remove all footers from the input document, false otherwise | [optional] [default to null]
